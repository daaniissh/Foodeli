...
const ShopListing = () => {
  ...
  // const [, ] = useState([{searchParams.get('categories') ? "d" : searchParams.get('categories') }]);
  const [selectedCategories, setSelectedCategories] = useState([searchParams.get('categories')]);
  const getFilteredProductsData = async () => {
    setLoading(true);
    // Call the API function for filtered products
    await getAllProducts(
      `minPrice=${priceRange[0]}&maxPrice=${priceRange[1]}${selectedCategories !=  ""
